...
import edu.hneu.kpp.labdao.hibernatedao.hibernate.dao.BookDaoInterface;
import edu.hneu.kpp.labdao.hibernatedao.hibernate.model.Book;

import java.util.List;

public class BookDao extends AbstractDao<Book, Integer> implements BookDaoInterface {
